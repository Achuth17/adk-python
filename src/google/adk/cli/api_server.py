...
def _get_scope_header(scope: dict[str, Any], header_name: bytes) -> Optional[str]:
...
class ApiServer:
    ...
    async def get_runner_async(self, app_name: str) -> Runner:
        ...
        def _maybe_add_bq_plugin(plugins: list[BasePlugin]) -> list[BasePlugin]:
            if bq_analytics_config and all(
                ...
                from ..plugins.bigquery_agent_analytics_plugin import (
    ...
    def _setup_runtime_config(self, web_assets_dir: str):
        ...
        try:
            ...
            logger.warning(
                "Failed to decode JSON from %s. The file content will be overwritten.",
                runtime_config_path,
            )
    ...
    def get_fast_api_app(
        ...
        setup_observer: Callable[[Observer, "ApiServer"], None] = lambda o, s: None,
        tear_down_observer: Callable[[Observer, "ApiServer"], None] = lambda o, s: None,
